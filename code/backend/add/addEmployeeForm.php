...
$(document).ready(function(){
    $("#projects").change(function(){
        ...
        $('#employeeSelector').load("http://novoteam.nl/backend/add/createAddForm.php?id=" + projectID);
    });
});
</script>
...
<html>
    <body>
        <h1>Add Employee</h1>
        <form name="selectForm" class="selectForm" style="padding-bottom: 20px;" action="../add/addEmployee.php" method="post">

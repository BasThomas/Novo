...
$(document).ready(function(){
    $("#projects").change(function(){
        ...
        $('#employeeSelector').load("http://novoteam.nl/backend/leader/createLeaderForm.php?id=" + projectID);
    });
});
</script>
...
<html>
    <body>
        <h1>Set Project Leader</h1>
        <form name="selectForm" class="selectForm" style="padding-bottom: 20px;" action="../leader/setLeader.php" method="post">
